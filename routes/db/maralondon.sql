...
CREATE TABLE historyPassword_list (
	num INTEGER NOT NULL,
	timeStampGMT0 BLOB DEFAULT NA NOT NULL,
	userID TEXT(100) DEFAULT NA NOT NULL,
...
CREATE TABLE userDetails_list (
	...
	userMyKad TEXT(250) DEFAULT NA NOT NULL,
	userEmail TEXT(250) DEFAULT NA NOT NULL,
	userDOB BLOB DEFAULT NA NOT NULL,
	...
	CONSTRAINT userDetails_list_FK_1 FOREIGN KEY (ethnicityCode) REFERENCES ethnicity_list(ethnicityCode) ON UPDATE CASCADE,
	CONSTRAINT userDetails_list_FK_2 FOREIGN KEY (genderCode) REFERENCES gender_list(genderCode) ON UPDATE CASCADE,
	CONSTRAINT userDetails_list_FK_3 FOREIGN KEY (stateCode) REFERENCES state_list(stateCode) ON UPDATE CASCADE,
	CONSTRAINT userDetails_list_FK_4 FOREIGN KEY (userID) REFERENCES user_list(userID)
);
...
CREATE TABLE userEducationDetails_list (
	...
	studyCompletionDate BLOB DEFAULT NA NOT NULL,
	...
	CONSTRAINT userEducationDetails_list_FK_4 FOREIGN KEY (instituteCode) REFERENCES institute_list(instituteCode) ON UPDATE CASCADE,
	CONSTRAINT userEducationDetails_list_FK_5 FOREIGN KEY (studySubjectCode) REFERENCES studySubject_list(studySubjectCode) ON UPDATE CASCADE,
	CONSTRAINT userEducationDetails_list_FK_6 FOREIGN KEY (studyLevelCode) REFERENCES studyLevel_list(studyLevelCode) ON UPDATE CASCADE,
	CONSTRAINT userEducationDetails_list_FK_7 FOREIGN KEY (userID) REFERENCES user_list(userID)
);
...
CREATE TABLE contactUs_messages (
	...
	senderWebsite TEXT(250) DEFAULT NA NOT NULL,
...
CREATE TABLE contactUs_student (
	...
	CONSTRAINT contactUs_student_FK FOREIGN KEY (refNum) REFERENCES contactUs_messages(refNum) ON UPDATE CASCADE,
	CONSTRAINT contactUs_student_FK_1 FOREIGN KEY (userID) REFERENCES user_list(userID)
);
...
SELECT 
	...
	`contactUs_student`.userID AS user_ID,
	...
	`contactUs_messages`.senderWebsite AS sender_website,
