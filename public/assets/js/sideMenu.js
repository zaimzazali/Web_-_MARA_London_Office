...
function set_button_Collapsed() {
  ...
  var btn = document.getElementById('holder_button_nav_group_2').getElementsByClassName('btn_nav');
  var i = 0;
...
function orientationChange() {
  ...
  setTimeout(function () {
    ...
    var heightDivBlocker = document.getElementById('container_body').offsetHeight;
    ...
    if (document.getElementById('holder_layers').style.display === 'block') {
      ...
      if (heightBackground < heightDivBlocker) {
        document.getElementById('holder_layers').style.height = heightDivBlocker + 'px';
      } else if (heightBackground > heightDivBlocker) {
        document.getElementById('holder_layers').style.height = heightBackground + 'px';
      }
    }
  }, 10);
}
