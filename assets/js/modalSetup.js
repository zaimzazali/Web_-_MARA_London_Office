...
function setTitleAndContent(btnObj, modalObj, btnName) {
  ...
  try {
    modalObj.getElementsByClassName("holder_body")[0].style.height = "auto";
  } catch (error) {
    try {
      modalObj.getElementsByClassName("form_container")[0].style.height =
        "auto";
    } catch (error) {
      // Do Nothing
    }
  ...
  switch (id) {
    case "item_disclaimer":
      modalObj.getElementsByClassName("modal_title")[0].innerHTML =
        "DISCLAIMER";
      modalObj.getElementsByClassName("holder_body")[0].innerHTML =
      ...
      modalObj.style.paddingBottom = "0.5em";
      break;

    case "item_privacy_policy":
      modalObj.getElementsByClassName("holder_body")[0].style.height = "50vh";
      modalObj.style.paddingBottom = "1em";
    ...
    case "btn_about":
      modalObj.getElementsByClassName("holder_body")[0].style.height = "70vh";
      modalObj.style.paddingBottom = "1em";
      break;
